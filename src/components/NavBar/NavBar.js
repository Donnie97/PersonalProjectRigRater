    ...
    render(){
        ...
        return (
            <nav className='wholeNav'>
                ...
                <Link to='/popular' className='Links'><li className='tabs1 tabs2 box'>Popular</li></Link>
             ...
             <a className='Links' href={process.env.REACT_APP_LOGIN}>
                ...
                <Link to='/popular' className='Links'><li className='tabs1'>Popular</li></Link>
                <Link to='/new' className='Links'><li className='tabs1'>New</li></Link>
